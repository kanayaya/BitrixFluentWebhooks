...
// Работа с чатами: https://dev.1c-bitrix.ru/learning/course/index.php?COURSE_ID=93&CHAPTER_ID=07689
     ...
     * Создание чата.<br>
     * Параметры:<br>
     * {@code MESSAGE} - Первое приветственное сообщение в чате. <b>Обязательный: </b>Нет. <b>Пример:</b> {@code Добро пожаловать в чат}. <b>С ревизии:</b> 18<br>
     * {@code ENTITY_ID} - Числовой идентификатор сущности, может быть использован для поиска чата и для легкого определения контекста в обработчиках событий ONIMBOTMESSAGEADD, ONIMBOTMESSAGEUPDATE, ONIMBOTMESSAGEDELETE. <b>Обязательный: </b>Нет. <b>Пример:</b> {@code 13}. <b>С ревизии:</b> 18<br>
     * {@code DESCRIPTION} - Описание чата. <b>Обязательный: </b>Нет. <b>Пример:</b> {@code Очень важный чат}. <b>С ревизии:</b> 18<br>
     * {@code COLOR} - Цвет чата для мобильного приложения: RED, GREEN, MINT, LIGHT_BLUE, DARK_BLUE, PURPLE, AQUA, PINK, LIME, BROWN, AZURE, KHAKI, SAND, MARENGO, GRAY, GRAPHITE. <b>Обязательный: </b>Нет. <b>Пример:</b> {@code PINK}. <b>С ревизии:</b> 18<br>
     * {@code TITLE} - Заголовок чата. <b>Обязательный: </b>Нет. <b>Пример:</b> {@code Мой новый закрытый чат}. <b>С ревизии:</b> 18<br>
     * {@code USERS} - Участники чата. <b>Обязательный: </b>Да. <b>Пример:</b> {@code Array(1,2)}. <b>С ревизии:</b> 18<br>
     * {@code AVATAR} - Аватар чата в base64 формате. <b>Обязательный: </b>Нет. <b>Пример:</b> {@code base64 image}. <b>С ревизии:</b> 18<br>
     * {@code TYPE} - Тип чата OPEN | CHAT (OPEN - открытый для вступления чат, CHAT - обычный чат по приглашениям, по-умолчанию CHAT). <b>Обязательный: </b>Нет. <b>Пример:</b> {@code CHAT}. <b>С ревизии:</b> 18<br>
     * {@code ENTITY_TYPE} - Идентификатор сущности, может быть использован для поиска по этому полю и для легкого определения контекста в обработчиках событий ONIMBOTMESSAGEADD, ONIMBOTMESSAGEUPDATE, ONIMBOTMESSAGEDELETE. <b>Обязательный: </b>Нет. <b>Пример:</b> {@code CHAT}. <b>С ревизии:</b> 18<br>
     * {@code OWNER_ID} - Идентификатор владельца чата. Можно не указывать, владельцем будет тот, от кого идёт запрос.. <b>Обязательный: </b>Нет. <b>Пример:</b> {@code 39}. <b>С ревизии:</b> 18<br>
     */
    IM_CHAT_ADD("im.chat.add"),
    /**
     * Получение списка участников.<br>
     * Параметры:<br>
     * {@code CHAT_ID} - Идентификатор чата. <b>Обязательный: </b>Да. <b>Пример:</b> {@code 13}. <b>С ревизии:</b> 18<br>
     */
     ...
     * Параметры:<br>
     * {@code CHAT_ID} - Идентификатор чата. <b>Обязательный: </b>Да. <b>Пример:</b> {@code 13}. <b>С ревизии:</b> 18<br>
     * {@code HIDE_HISTORY} - Отображение истории переписки для пользователя, которого добавляют в чат этим методом. Y/N - по умолчанию N. Если передать Y то новый пользователь не будет видеть историю.. <b>Обязательный: </b>Нет. <b>Пример:</b> {@code N}. <b>С ревизии:</b> 18<br>
     * {@code USERS} - Идентификаторы новых пользователей. <b>Обязательный: </b>Да. <b>Пример:</b> {@code Array(3,4)}. <b>С ревизии:</b> 18<br>
     */
     ...
     * Параметры:<br>
     * {@code CHAT_ID} - Идентификатор чата. <b>Обязательный: </b>Да. <b>Пример:</b> {@code 13}. <b>С ревизии:</b> 18<br>
     * {@code USER_ID} - Идентификатор исключаемого пользователя. <b>Обязательный: </b>Да. <b>Пример:</b> {@code 4}. <b>С ревизии:</b> 18<br>
     */
     ...
     * Параметры:<br>
     * {@code CHAT_ID} - Идентификатор чата. <b>Обязательный: </b>Нет. <b>Пример:</b> {@code 13}. <b>С ревизии:</b> 18<br>
     * {@code TITLE} - Новый заголовок. <b>Обязательный: </b>Нет. <b>Пример:</b> {@code Новое имя для чата}. <b>С ревизии:</b> 18<br>
     */
    IM_CHAT_UPDATETITLE("im.chat.updateTitle"),
    /**
     * Обновление цвета чата.<br>
     * Параметры:<br>
     * {@code COLOR} - Цвет чата для мобильного приложения (RED, GREEN, MINT, LIGHT_BLUE, DARK_BLUE, PURPLE, AQUA, PINK, LIME, BROWN, AZURE, KHAKI, SAND, MARENGO, GRAY, GRAPHITE). <b>Обязательный: </b>Да. <b>Пример:</b> {@code MINT}. <b>С ревизии:</b> 18<br>
     * {@code CHAT_ID} - Идентификатор чата. <b>Обязательный: </b>Да. <b>Пример:</b> {@code 13}. <b>С ревизии:</b> 18<br>
     */
     ...
     * Параметры:<br>
     * {@code CHAT_ID} - Идентификатор чата. <b>Обязательный: </b>Да. <b>Пример:</b> {@code 13}. <b>С ревизии:</b> 18<br>
     * {@code AVATAR} - Изображение в формате base64. <b>Обязательный: </b>Да. <b>Пример:</b> {@code  *base64 image* }. <b>С ревизии:</b> 18<br>
     */
     ...
     * Параметры:<br>
     * {@code ENTITY_ID} - Числовой идентификатор сущности. Может быть использован для поиска чата и для легкого определения контекста в обработчиках событий ONIMBOTMESSAGEADD, ONIMBOTMESSAGEUPDATE, ONIMBOTMESSAGEDELETE. <b>Обязательный: </b>Да. <b>Пример:</b> {@code LEAD|13 - для CRM, facebook|2|1647215182041969|862 - для открытых линий ENTITY_ID совпадает с USER_CODE из сессии.}. <b>С ревизии:</b> 18<br>
     * {@code ENTITY_TYPE} - Идентификатор сущности. Может быть использован для поиска чата и для легкого определения контекста в обработчиках событий ONIMBOTMESSAGEADD, ONIMBOTMESSAGEUPDATE, ONIMBOTMESSAGEDELETE. <b>Обязательный: </b>Да. <b>Пример:</b> {@code CRM - для CRM, LINES Со стороны оператора или LIVECHAT Со стороны пользователя - для открытых линий}. <b>С ревизии:</b> 18<br>
     */
    IM_CHAT_GET("im.chat.get"),
    /**
     * Отключение уведомлений в чате.<br>
     * Параметры:<br>
     * {@code CHAT_ID} - Идентификатор чата. <b>Обязательный: </b>Да. <b>Пример:</b> {@code 17}. <b>С ревизии:</b> 19<br>
     * {@code MUTE} - Отключить или включить уведомления - Y|N. <b>Обязательный: </b>Да. <b>Пример:</b> {@code Y}. <b>С ревизии:</b> 19<br>
     */
...
// Работа с диалогами: https://dev.1c-bitrix.ru/learning/course/index.php?COURSE_ID=93&CHAPTER_ID=011477
     ...
     * Параметры:<br>
     * {@code DIALOG_ID} - Идентификатор диалога. Формат: chatXXX – чат получателя, если сообщение для чата или XXX – идентификатор получателя, если сообщение для приватного диалога. <b>Обязательный: </b>Да. <b>Пример:</b> {@code chat29 или 256}. <b>С ревизии:</b> 19<br>
     * {@code FIRST_ID} - Идентификатор первого загруженного сообщения. <b>Обязательный: </b>Нет. <b>Пример:</b> {@code 454322}. <b>С ревизии:</b> 19<br>
     * {@code LAST_ID} - Идентификатор последнего загруженного сообщения. <b>Обязательный: </b>Нет. <b>Пример:</b> {@code 28561624}. <b>С ревизии:</b> 19<br>
     * {@code LIMIT} - Ограничение на выборку сообщений в диалоге. <b>Обязательный: </b>Нет. <b>Пример:</b> {@code 20}. <b>С ревизии:</b> 19<br>
     */
     ...
     * Параметры:<br>
     * {@code DIALOG_ID} - Идентификатор диалога. Формат: chatXXX – чат получателя, если сообщение для чата или XXX – идентификатор получателя, если сообщение для приватного диалога. <b>Обязательный: </b>Да. <b>Пример:</b> {@code chat29 или 256}. <b>С ревизии:</b> 21<br>
     * {@code MESSAGE_ID} - Идентификатор последнего прочитанного сообщения в диалоге. <b>Обязательный: </b>Да. <b>Пример:</b> {@code 12}. <b>С ревизии:</b> 21<br>
     */
     ...
     * Параметры:<br>
     * {@code DIALOG_ID} - Идентификатор диалога. Формат: chatXXX – чат получателя, если сообщение для чата или XXX – идентификатор получателя, если сообщение для приватного диалога. <b>Обязательный: </b>Да. <b>Пример:</b> {@code chat29 или 256}. <b>С ревизии:</b> 21<br>
     * {@code MESSAGE_ID} - Идентификатор первого непрочитанного диалога. <b>Обязательный: </b>Да. <b>Пример:</b> {@code 12}. <b>С ревизии:</b> 21<br>
     */
    IM_DIALOG_UNREAD("im.dialog.unread"),
    /**
     * Получение информации об участниках чата (поддерживается пагинация).<br>
     * Параметры:<br>
     * {@code DIALOG_ID} - Идентификатор диалога. Формат: chatXXX – чат получателя, если сообщение для чата или XXX – идентификатор получателя, если сообщение для приватного диалога. <b>Обязательный: </b>Да. <b>Пример:</b> {@code chat74}. <b>С ревизии:</b> 30<br>
     * {@code SKIP_EXTERNAL_EXCEPT_TYPES} - Строка с теми типами системных пользователей, которых нужно оставить в выборке. <b>Обязательный: </b>Нет. <b>Пример:</b> {@code 'bot, email'}. <b>С ревизии:</b> 30<br>
     */
    IM_DIALOG_USERS_LIST("im.dialog.users.list"),
    /**
     * Отправка статуса «вам пишут...».<br>
     * Параметры:<br>
     * {@code DIALOG_ID} - Идентификатор диалога. Формат: chatXXX – чат получателя, если сообщение для чата или XXX – идентификатор получателя, если сообщение для приватного диалога. <b>Обязательный: </b>Да. <b>Пример:</b> {@code 13}. <b>С ревизии:</b> 30<br>
     */
...
// Работа с сообщениями: https://dev.1c-bitrix.ru/learning/course/index.php?COURSE_ID=93&CHAPTER_ID=07691
     ...
     * Параметры:<br>
     * {@code SYSTEM} - Отображать сообщения в виде системного сообщения или нет, необязательное поле, по умолчанию 'N'. <b>Обязательный: </b>Нет. <b>Пример:</b> {@code N}. <b>С ревизии:</b> 18<br>
     * {@code DIALOG_ID} - Идентификатор диалога. Формат: chatXXX – чат получателя, если сообщение для чата или XXX – идентификатор получателя, если сообщение для приватного диалога. <b>Обязательный: </b>Да. <b>Пример:</b> {@code chat13 или 256}. <b>С ревизии:</b> 18<br>
     * {@code MESSAGE} - Текст сообщения. <b>Обязательный: </b>Да. <b>Пример:</b> {@code Текст сообщения}. <b>С ревизии:</b> 18<br>
     * {@code URL_PREVIEW} - Преобразовывать ссылки в rich-ссылки, необязательное поле, по умолчанию 'Y'. <b>Обязательный: </b>Нет. <b>Пример:</b> {@code Y}. <b>С ревизии:</b> 18<br>
     * {@code ATTACH} - Вложение. <b>Обязательный: </b>Нет. <b>Пример:</b> {@code }. <b>С ревизии:</b> 18<br>
     * {@code KEYBOARD} - Клавиатура. <b>Обязательный: </b>Нет. <b>Пример:</b> {@code }. <b>С ревизии:</b> 18<br>
     * {@code MENU} - Контекстное меню. <b>Обязательный: </b>Нет. <b>Пример:</b> {@code }. <b>С ревизии:</b> 18<br>
     */
    IM_MESSAGE_ADD("im.message.add"),
    /**
     * Отправка изменения сообщения чат-бота.<br>
     * Параметры:<br>
     * {@code URL_PREVIEW} - Преобразовывать ссылки в rich-ссылки. <b>Обязательный: </b>Нет. <b>Пример:</b> {@code Y}. <b>С ревизии:</b> 18<br>
     * {@code ATTACH} - Вложение. <b>Обязательный: </b>Нет. <b>Пример:</b> {@code }. <b>С ревизии:</b> 18<br>
     * {@code MESSAGE_ID} - Идентификатор сообщения. <b>Обязательный: </b>Да. <b>Пример:</b> {@code 1}. <b>С ревизии:</b> 18<br>
     * {@code KEYBOARD} - Клавиатура. <b>Обязательный: </b>Нет. <b>Пример:</b> {@code }. <b>С ревизии:</b> 18<br>
     * {@code MENU} - Контекстное меню. <b>Обязательный: </b>Нет. <b>Пример:</b> {@code }. <b>С ревизии:</b> 18<br>
     */
     ...
     * Параметры:<br>
     * {@code MESSAGE_ID} - Идентификатор сообщения (любое сообщение, отправленное в личных диалогах или в групповых чатах, где присутствует чат-бот). <b>Обязательный: </b>Да. <b>Пример:</b> {@code 1}. <b>С ревизии:</b> 18<br>
     */
    IM_MESSAGE_LIKE("im.message.like"),
    /**
     * Использование команды бота.<br>
     * Параметры:<br>
     * {@code MESSAGE_ID} - Идентификатор сообщения с возможностью отдать команду боту. <b>Обязательный: </b>Да. <b>Пример:</b> {@code 278}. <b>С ревизии:</b> 30<br>
     * {@code COMMAND} - Команда, которую должен выполнить бот. <b>Обязательный: </b>Да. <b>Пример:</b> {@code 'KEYBOARD'}. <b>С ревизии:</b> 30<br>
     */
     ...
     * Параметры:<br>
     * {@code MESSAGE_ID} - Идентификатор сообщения, по которому будет создана новая сущность. <b>Обязательный: </b>Да. <b>Пример:</b> {@code 289}. <b>С ревизии:</b> 30<br>
     * {@code TYPE} - Тип создаваемой сущности: 'CHAT' – по сообщению будет создан новый чат 'TASK' – по сообщению будет создана задача 'POST' – по сообщению будет создан пост в Новостях 'CALEND' – по сообщению будет создано событие в календаре. <b>Обязательный: </b>Да. <b>Пример:</b> {@code 'TASK'}. <b>С ревизии:</b> 30<br>
     */
...
// Работа с файлами: https://dev.1c-bitrix.ru/learning/course/index.php?COURSE_ID=93&CHAPTER_ID=011481
     ...
     * Параметры:<br>
     * {@code CHAT_ID} - Идентификатор чата. <b>Обязательный: </b>Да. <b>Пример:</b> {@code 17}. <b>С ревизии:</b> 18<br>
     */
    IM_DISK_FOLDER_GET("im.disk.folder.get"),
    /**
     * Публикация загруженного файла в чат.<br>
     * Параметры:<br>
     * {@code MESSAGE} - Описание файла будет опубликовано в чате. <b>Обязательный: </b>Нет. <b>Пример:</b> {@code Важный документ}. <b>С ревизии:</b> 18<br>
     * {@code DISK_ID} - Идентификатор файла, доступного из локального диска. <b>Обязательный: </b>Да*. <b>Пример:</b> {@code 112}. <b>С ревизии:</b> 18<br>
     * {@code CHAT_ID} - Идентификатор чата. <b>Обязательный: </b>Да. <b>Пример:</b> {@code 17}. <b>С ревизии:</b> 18<br>
     * {@code SILENT_MODE} - Параметр для чата Открытых линий, обозначает, будет ли отправлена информация о файле клиенту или нет. <b>Обязательный: </b>Нет. <b>Пример:</b> {@code N}. <b>С ревизии:</b> 18<br>
     * {@code UPLOAD_ID} - Идентификатор загруженного файла через методы модуля DISK. <b>Обязательный: </b>Да*. <b>Пример:</b> {@code 213}. <b>С ревизии:</b> 18<br>
     */
    IM_DISK_FILE_COMMIT("im.disk.file.commit"),
    /**
     * Удаление файлов внутри папки чата.<br>
     * Параметры:<br>
     * {@code DISK_ID} - Идентификатор файла. <b>Обязательный: </b>Да. <b>Пример:</b> {@code 112}. <b>С ревизии:</b> 18<br>
     * {@code CHAT_ID} - Идентификатор чата. <b>Обязательный: </b>Да. <b>Пример:</b> {@code 17}. <b>С ревизии:</b> 18<br>
     */
     ...
     * Параметры:<br>
     * {@code DISK_ID} - Идентификатор файла. <b>Обязательный: </b>Да. <b>Пример:</b> {@code 112}. <b>С ревизии:</b> 21<br>
     */
...
// Работа с пользователями: https://dev.1c-bitrix.ru/learning/course/index.php?COURSE_ID=93&CHAPTER_ID=011489
     ...
     * Параметры:<br>
     * {@code ID} - Идентификатор пользователя. <b>Обязательный: </b>Нет. <b>Пример:</b> {@code 5}. <b>С ревизии:</b> 18<br>
     * {@code AVATAR_HR} - Генерировать аватар в высоком разрешении. <b>Обязательный: </b>Нет. <b>Пример:</b> {@code N}. <b>С ревизии:</b> 18<br>
     */
    IM_USER_GET("im.user.get"),
    /**
     * Получение данных о пользователях.<br>
     * Параметры:<br>
     * {@code ID} - Идентификаторы пользователей. <b>Обязательный: </b>Да. <b>Пример:</b> {@code [4,5]}. <b>С ревизии:</b> 19<br>
     * {@code AVATAR_HR} - Генерировать аватар в высоком разрешении. <b>Обязательный: </b>Нет. <b>Пример:</b> {@code N}. <b>С ревизии:</b> 19<br>
     */
     ...
     * Параметры:<br>
     * {@code STATUS} - Новый статус пользователя. <b>Обязательный: </b>Да. <b>Пример:</b> {@code online}. <b>С ревизии:</b> 18<br>
     */
    IM_USER_STATUS_SET("im.user.status.set"),
    /**
     * Установка автоматического статуса «Отошел».<br>
     * Параметры:<br>
     * {@code AGO} - Сколько минут назад отошел. <b>Обязательный: </b>Нет. <b>Пример:</b> {@code 10}. <b>С ревизии:</b> 18<br>
     */
...
// Работа с подразделениями: https://dev.1c-bitrix.ru/learning/course/index.php?COURSE_ID=93&CHAPTER_ID=011505
     ...
     * Параметры:<br>
     * {@code ID} - Идентификаторы подразделений. <b>Обязательный: </b>Да. <b>Пример:</b> {@code [51]}. <b>С ревизии:</b> 18<br>
     * {@code USER_DATA} - Подгружать данные о пользователях. <b>Обязательный: </b>Нет. <b>Пример:</b> {@code N}. <b>С ревизии:</b> 18<br>
     */
    IM_DEPARTMENT_GET("im.department.get"),
    /**
     * Получение списка пользователей, состоящих в вашем отделе.<br>
     * Параметры:<br>
     * {@code OFFSET} - Смещение выборки пользователей. <b>Обязательный: </b>Нет. <b>Пример:</b> {@code 0}. <b>С ревизии:</b> 19<br>
     * {@code LIMIT} - Лимит выборки пользователей. <b>Обязательный: </b>Нет. <b>Пример:</b> {@code 10}. <b>С ревизии:</b> 19<br>
     * {@code USER_DATA} - Подгружать данные о пользователях. <b>Обязательный: </b>Нет. <b>Пример:</b> {@code N}. <b>С ревизии:</b> 19<br>
     */
    IM_DEPARTMENT_COLLEAGUES_LIST("im.department.colleagues.list"),
    /**
     * Получение списка руководителей подразделений.<br>
     * Параметры:<br>
     * {@code ID} - Идентификаторы подразделений. <b>Обязательный: </b>Да. <b>Пример:</b> {@code [105]}. <b>С ревизии:</b> 19<br>
     * {@code USER_DATA} - Подгружать данные о пользователях. <b>Обязательный: </b>Нет. <b>Пример:</b> {@code N}. <b>С ревизии:</b> 19<br>
     */
...
// Работа с поиском: https://dev.1c-bitrix.ru/learning/course/index.php?COURSE_ID=93&CHAPTER_ID=011515
     ...
     * Параметры:<br>
     * {@code FIND} - Поисковая фраза. <b>Обязательный: </b>Да. <b>Пример:</b> {@code Евгений}. <b>С ревизии:</b> 19<br>
     * {@code OFFSET} - Смещение выборки пользователей. <b>Обязательный: </b>Нет. <b>Пример:</b> {@code 0}. <b>С ревизии:</b> 19<br>
     * {@code BUSINESS} - Поиск среди бизнес пользователей. <b>Обязательный: </b>Нет. <b>Пример:</b> {@code N}. <b>С ревизии:</b> 19<br>
     * {@code LIMIT} - Лимит выборки пользователей. <b>Обязательный: </b>Нет. <b>Пример:</b> {@code 10}. <b>С ревизии:</b> 19<br>
     * {@code AVATAR_HR} - Генировать аватар в высоком разрешении. <b>Обязательный: </b>Нет. <b>Пример:</b> {@code N}. <b>С ревизии:</b> 19<br>
     */
    IM_SEARCH_USER_LIST("im.search.user.list"),
    /**
     * Поиск чатов.<br>
     * Параметры:<br>
     * {@code FIND} - Поисковая фраза. <b>Обязательный: </b>Да. <b>Пример:</b> {@code Мятный}. <b>С ревизии:</b> 19<br>
     * {@code OFFSET} - Смещение выборки пользователей. <b>Обязательный: </b>Нет. <b>Пример:</b> {@code 0}. <b>С ревизии:</b> 19<br>
     * {@code LIMIT} - Лимит выборки пользователей. <b>Обязательный: </b>Нет. <b>Пример:</b> {@code 10}. <b>С ревизии:</b> 19<br>
     */
     ...
     * Параметры:<br>
     * {@code FIND} - Поисковая фраза. <b>Обязательный: </b>Да. <b>Пример:</b> {@code Московский}. <b>С ревизии:</b> 19<br>
     * {@code OFFSET} - Смещение выборки пользователей. <b>Обязательный: </b>Нет. <b>Пример:</b> {@code 0}. <b>С ревизии:</b> 19<br>
     * {@code LIMIT} - Лимит выборки пользователей. <b>Обязательный: </b>Нет. <b>Пример:</b> {@code 10}. <b>С ревизии:</b> 19<br>
     * {@code USER_DATA} - Подгружать данные о пользователях. <b>Обязательный: </b>Нет. <b>Пример:</b> {@code N}. <b>С ревизии:</b> 19<br>
     */
     ...
     * Параметры:<br>
     * {@code SKIP_DIALOG} - Пропускать диалоги один-на-один. <b>Обязательный: </b>Нет. <b>Пример:</b> {@code N}. <b>С ревизии:</b> 18<br>
     * {@code SKIP_OPENLINES} - Пропускать чаты открытых линий. <b>Обязательный: </b>Нет. <b>Пример:</b> {@code N}. <b>С ревизии:</b> 18<br>
     * {@code SKIP_CHAT} - Пропускать чаты. <b>Обязательный: </b>Нет. <b>Пример:</b> {@code N}. <b>С ревизии:</b> 18<br>
     */
    IM_SEARCH_LAST_GET("im.search.last.get"),
    /**
     * Добавление элемента истории последнего поиска.<br>
     * Параметры:<br>
     * {@code DIALOG_ID} - Идентификатор диалога. Формат: chatXXX – чат получателя, если сообщение для чата или XXX – идентификатор получателя, если сообщение для приватного диалога. <b>Обязательный: </b>Да. <b>Пример:</b> {@code chat17 или 256}. <b>С ревизии:</b> 18<br>
     */
...
// Работа со списком последних чатов: https://dev.1c-bitrix.ru/learning/course/index.php?COURSE_ID=93&CHAPTER_ID=011531
     ...
     * Параметры:<br>
     * {@code SKIP_DIALOG} - Пропускать диалоги один-на-один. <b>Обязательный: </b>Нет. <b>Пример:</b> {@code N}. <b>С ревизии:</b> 18<br>
     * {@code ONLY_OPENLINES} - Выборка только чатов открытых линий. <b>Обязательный: </b>Нет. <b>Пример:</b> {@code N}. <b>С ревизии:</b> 29<br>
     * {@code LAST_UPDATE} - Ограничение выборки для минимизации переданных данных, дата в формате ATOM. <b>Обязательный: </b>Нет. <b>Пример:</b> {@code 2019-07-11T10:45:31+02:00}. <b>С ревизии:</b> 23<br>
     * {@code SKIP_OPENLINES} - Пропускать чаты открытых линий. <b>Обязательный: </b>Нет. <b>Пример:</b> {@code N}. <b>С ревизии:</b> 18<br>
     * {@code SKIP_CHAT} - Пропускать чаты. <b>Обязательный: </b>Нет. <b>Пример:</b> {@code N}. <b>С ревизии:</b> 18<br>
     * {@code LAST_SYNC_DATE} - Дата предыдущей выборки для загрузки изменений, произошедших в списке с этого времени. Выборка возвращает данные не старше 7 дней. Дата в формате ATOM. <b>Обязательный: </b>Нет. <b>Пример:</b> {@code 2019-07-11T10:45:31+02:00}. <b>С ревизии:</b> 29<br>
     */
    IM_RECENT_GET("im.recent.get"),
    /**
     * Закрепление диалога в избранном.<br>
     * Параметры:<br>
     * {@code DIALOG_ID} - Идентификатор диалога. Формат: chatXXX – чат получателя, если сообщение для чата или XXX – идентификатор получателя, если сообщение для приватного диалога. <b>Обязательный: </b>Да. <b>Пример:</b> {@code chat17 или 256}. <b>С ревизии:</b> 19<br>
     * {@code PIN} - Закрепить или открепить диалог. <b>Обязательный: </b>Нет. <b>Пример:</b> {@code Y}. <b>С ревизии:</b> 19<br>
     */
     ...
     * Параметры:<br>
     * {@code SKIP_OPENLINES} - Пропускать чаты открытых линий. <b>Обязательный: </b>Нет. <b>Пример:</b> {@code 'Y'}. <b>С ревизии:</b> 30<br>
     * {@code SKIP_CHAT} - Пропускать чаты. <b>Обязательный: </b>Нет. <b>Пример:</b> {@code 'Y'}. <b>С ревизии:</b> 30<br>
     */
...
// Работа с уведомлениями: https://dev.1c-bitrix.ru/learning/course/index.php?COURSE_ID=93&CHAPTER_ID=07693
     ...
     * Параметры:<br>
     * {@code SUB_TAG} - Дополнительный тег, без проверки на уникальность. <b>Обязательный: </b>Нет. <b>Пример:</b> {@code SUB|TEST}. <b>С ревизии:</b> 18<br>
     * {@code USER_ID} - Идентификатор пользователя, кому будет адресовано уведомление. <b>Обязательный: </b>Да. <b>Пример:</b> {@code 1}. <b>С ревизии:</b> 18<br>
     * {@code MESSAGE_OUT} - Текст уведомления для почты. Если не задано, то используется поле MESSAGE. <b>Обязательный: </b>Нет. <b>Пример:</b> {@code Текст персонального уведомления для почты}. <b>С ревизии:</b> 18<br>
     */
     ...
     * {@code SUB_TAG} - Дополнительный тег, без проверки на уникальность. <b>Обязательный: </b>Нет. <b>Пример:</b> {@code SUB|TEST}. <b>С ревизии:</b> 18<br>
     * {@code USER_ID} - Идентификатор пользователя, кому будет адресовано уведомление. <b>Обязательный: </b>Да. <b>Пример:</b> {@code 1}. <b>С ревизии:</b> 18<br>
     * {@code MESSAGE_OUT} - Текст уведомления для почты. Если не задано, то используется поле MESSAGE. <b>Обязательный: </b>Нет. <b>Пример:</b> {@code Текст системного уведомления для почты}. <b>С ревизии:</b> 18<br>
     */
    IM_NOTIFY_SYSTEM_ADD("im.notify.system.add"),
    /**
     * Удаление уведомления.<br>
     * Параметры:<br>
     * {@code SUB_TAG} - Дополнительный тег, без проверки на уникальность. <b>Обязательный: </b>Да*. <b>Пример:</b> {@code SUB|TEST}. <b>С ревизии:</b> 18<br>
     * {@code ID} - Идентификатор уведомления. <b>Обязательный: </b>Да*. <b>Пример:</b> {@code 123}. <b>С ревизии:</b> 18<br>
     */
    IM_NOTIFY_DELETE("im.notify.delete"),
    /**
     * Установка отмены о прочитанных уведомлениях.<br>
     * Параметры:<br>
     * {@code ONLY_CURRENT} - Прочитать только указанное уведомление. <b>Обязательный: </b>Нет. <b>Пример:</b> {@code N}. <b>С ревизии:</b> 18<br>
     * {@code ID} - Идентификатор уведомления. <b>Обязательный: </b>Да. <b>Пример:</b> {@code 17}. <b>С ревизии:</b> 18<br>
     */
    IM_NOTIFY_READ("im.notify.read"),
    /**
     * «Прочтение» списка уведомлений, исключая уведомления типа CONFIRM.<br>
     * Параметры:<br>
     * {@code IDS} - Массив идентификаторов уведомлений. <b>Обязательный: </b>Да. <b>Пример:</b> {@code [1,2,3]}. <b>С ревизии:</b> 30<br>
     */
    IM_NOTIFY_READ_LIST("im.notify.read.list"),
    /**
     * Ответ на уведомление, поддерживающее быстрый ответ.<br>
     * Параметры:<br>
     * {@code ID} - Идентификатор уведомления, поддерживающего быстрый ответ. <b>Обязательный: </b>Да. <b>Пример:</b> {@code 270}. <b>С ревизии:</b> 30<br>
     */
    IM_NOTIFY_ANSWER("im.notify.answer"),
    /**
     * Взаимодействие с кнопками нотификаций.<br>
     * Параметры:<br>
     * {@code ID} - Идентификатор уведомления, поддерживающего выбор ответа посредством нажатия на кнопки. <b>Обязательный: </b>Да. <b>Пример:</b> {@code 288}. <b>С ревизии:</b> 30<br>
     */
