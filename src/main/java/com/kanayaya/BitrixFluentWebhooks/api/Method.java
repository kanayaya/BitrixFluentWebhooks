...
// Настройка приложений: https://dev.1c-bitrix.ru/rest_help/general/application/index.php
     ...
     */
    USER_OPTION_GET("user.option.get"),
    /**
     * Методы привязки данных к приложению и пользователю<br>
     */
    USER_OPTION_SET("user.option.set"),
...
// Работа с уведомлениями: https://dev.1c-bitrix.ru/learning/course/index.php?COURSE_ID=93&CHAPTER_ID=07693
    ...
    TASK_CTASKITEM_GETMANIFEST("task.ctaskitem.getmanifest"),
    TASK_CTASKITEM_GETLIST("task.ctaskitem.getlist"),
    TASK_ITEM_GETLIST("task.item.getlist"),
    TASK_CTASKITEM_LIST("task.ctaskitem.list"),
    TASK_CTASKITEM_ADD("task.ctaskitem.add"),
    TASK_CTASKITEM_GETEXECUTIVEUSERID("task.ctaskitem.getexecutiveuserid"),
    TASK_ITEM_GETEXECUTIVEUSERID("task.item.getexecutiveuserid"),
    TASK_CTASKITEM_GETDATA("task.ctaskitem.getdata"),
    TASK_CTASKITEM_GETDESCRIPTION("task.ctaskitem.getdescription"),
    TASK_CTASKITEM_GETFILES("task.ctaskitem.getfiles"),
    TASK_CTASKITEM_ADDFILE("task.ctaskitem.addfile"),
    TASK_CTASKITEM_DELETEFILE("task.ctaskitem.deletefile"),
    TASK_CTASKITEM_GETTAGS("task.ctaskitem.gettags"),
    TASK_ITEM_GETTAGS("task.item.gettags"),
    TASK_CTASKITEM_GETDEPENDSON("task.ctaskitem.getdependson"),
    TASK_CTASKITEM_GETALLOWEDTASKACTIONS("task.ctaskitem.getallowedtaskactions"),
    TASK_CTASKITEM_GETALLOWEDACTIONS("task.ctaskitem.getallowedactions"),
    TASK_ITEM_GETALLOWEDTASKACTIONS("task.item.getallowedtaskactions"),
    TASK_CTASKITEM_GETALLOWEDTASKACTIONSASSTRINGS("task.ctaskitem.getallowedtaskactionsasstrings"),
    TASK_CTASKITEM_ISACTIONALLOWED("task.ctaskitem.isactionallowed"),
    TASK_CTASKITEM_DELETE("task.ctaskitem.delete"),
    TASK_CTASKITEM_DELEGATE("task.ctaskitem.delegate"),
    TASK_CTASKITEM_STARTEXECUTION("task.ctaskitem.startexecution"),
    TASK_CTASKITEM_PAUSEEXECUTION("task.ctaskitem.pauseexecution"),
    TASK_ITEM_PAUSEEXECUTION("task.item.pauseexecution"),
    TASK_CTASKITEM_DEFER("task.ctaskitem.defer"),
    TASK_CTASKITEM_COMPLETE("task.ctaskitem.complete"),
    TASK_CTASKITEM_UPDATE("task.ctaskitem.update"),
    TASK_CTASKITEM_RENEW("task.ctaskitem.renew"),
    TASK_CTASKITEM_APPROVE("task.ctaskitem.approve"),
    TASK_CTASKITEM_DISAPPROVE("task.ctaskitem.disapprove"),
    TASK_CTASKITEM_ADDTOFAVORITE("task.ctaskitem.addtofavorite"),
    TASK_ITEM_ADDTOFAVORITE("task.item.addtofavorite"),
    TASK_CTASKITEM_DELETEFROMFAVORITE("task.ctaskitem.deletefromfavorite"),
    TASK_CTASKELAPSEDITEM_GETMANIFEST("task.ctaskelapseditem.getmanifest"),
    TASK_CTASKELAPSEDITEM_GETLIST("task.ctaskelapseditem.getlist"),
    TASK_CTASKELAPSEDITEM_GET("task.ctaskelapseditem.get"),
    TASK_CTASKELAPSEDITEM_ADD("task.ctaskelapseditem.add"),
    TASK_CTASKELAPSEDITEM_UPDATE("task.ctaskelapseditem.update"),
    TASK_CTASKELAPSEDITEM_DELETE("task.ctaskelapseditem.delete"),
    TASK_CTASKELAPSEDITEM_ISACTIONALLOWED("task.ctaskelapseditem.isactionallowed"),
    TASK_CTASKCOMMENTITEM_GETMANIFEST("task.ctaskcommentitem.getmanifest"),
    TASK_CTASKCOMMENTITEM_GETLIST("task.ctaskcommentitem.getlist"),
    TASK_CTASKCOMMENTITEM_GET("task.ctaskcommentitem.get"),
    TASK_CTASKCOMMENTITEM_ADD("task.ctaskcommentitem.add"),
    TASK_CTASKCOMMENTITEM_UPDATE("task.ctaskcommentitem.update"),
    TASK_CTASKCOMMENTITEM_DELETE("task.ctaskcommentitem.delete"),
    TASK_CTASKCOMMENTITEM_ISACTIONALLOWED("task.ctaskcommentitem.isactionallowed"),
    TASK_CTASKCHECKLISTITEM_GETMANIFEST("task.ctaskchecklistitem.getmanifest"),
    TASK_CTASKCHECKLISTITEM_GET("task.ctaskchecklistitem.get"),
    TASK_CTASKCHECKLISTITEM_GETLIST("task.ctaskchecklistitem.getlist"),
    TASK_CTASKCHECKLISTITEM_ADD("task.ctaskchecklistitem.add"),
    TASK_CTASKCHECKLISTITEM_UPDATE("task.ctaskchecklistitem.update"),
    TASK_CTASKCHECKLISTITEM_DELETE("task.ctaskchecklistitem.delete"),
    TASK_CTASKCHECKLISTITEM_COMPLETE("task.ctaskchecklistitem.complete"),
    TASK_CTASKCHECKLISTITEM_RENEW("task.ctaskchecklistitem.renew"),
    TASK_CTASKCHECKLISTITEM_MOVEAFTERITEM("task.ctaskchecklistitem.moveafteritem"),
    TASK_CTASKCHECKLISTITEM_ISACTIONALLOWED("task.ctaskchecklistitem.isactionallowed"),
    TASK_CTASKPLANNERMAINTANCE_GETCURRENTTASKSLIST("task.ctaskplannermaintance.getcurrenttaskslist"),
    TASK_CTASKPLANNERMAINTANCE_GETLIST("task.ctaskplannermaintance.getlist"),
    TASK_PLANNER_GETCURRENTTASKSLIST("task.planner.getcurrenttaskslist"),
    TASK_CTASKLOGITEM_GETMANIFEST("task.ctasklogitem.getmanifest"),
    TASK_LOGITEM_GETMANIFEST("task.logitem.getmanifest"),
    TASK_CTASKLOGITEM_LIST("task.ctasklogitem.list"),
    TASK_CTASKCOMMENTS_GETMANIFEST("task.ctaskcomments.getmanifest"),
    TASK_COMMENT_GETMANIFEST("task.comment.getmanifest"),
    TASK_CTASKCOMMENTS_ADD("task.ctaskcomments.add"),
    TASK_COMMENT_ADD("task.comment.add"),
    TASK_CTASKS_GETLIST("task.ctasks.getlist"),
    TASK_ITEMS_GETLIST("task.items.getlist"),
    TASKS_EXTENDED_META_SETANYSTATUS("tasks_extended.meta.setanystatus"),
    TASKS_EXTENDED_META_OCCURINLOGSAS("tasks_extended.meta.occurinlogsas"),
    LOG_BLOGCOMMENT_DELETE("log.blogcomment.delete"),
    LOG_COMMENT_DELETE("log.comment.delete"),
    SONET_GROUP_SUBJECT_GET("sonet_group_subject.get"),
    SONET_GROUP_SUBJECT_ADD("sonet_group_subject.add"),
    SONET_GROUP_SUBJECT_UPDATE("sonet_group_subject.update"),
    SONET_GROUP_SUBJECT_DELETE("sonet_group_subject.delete"),
    SIGN_B2E_HCMLINK_DOCUMENT_GET("sign.b2e.hcmlink.document.get"),
    SIGN_B2E_PROVIDER_ADD("sign.b2e.provider.add"),
    SIGN_B2E_PROVIDER_UPDATE("sign.b2e.provider.update"),
    SIGN_B2E_PROVIDER_DELETE("sign.b2e.provider.delete"),
    SIGN_B2E_PROVIDER_TAIL("sign.b2e.provider.tail"),
    SIGN_B2E_MYSAFE_TAIL("sign.b2e.mysafe.tail"),
    SIGN_B2E_PERSONAL_TAIL("sign.b2e.personal.tail"),
    SALE_CASHBOX_SETTINGS_GET("sale.cashbox.settings.get"),
    SALE_CASHBOX_SETTINGS_UPDATE("sale.cashbox.settings.update"),
    SALE_CASHBOX_OFD_SETTINGS_GET("sale.cashbox.ofd.settings.get"),
    SALE_CASHBOX_OFD_SETTINGS_UPDATE("sale.cashbox.ofd.settings.update"),
    SALE_OFD_LIST("sale.ofd.list"),
    SALE_OFD_SETTINGS_GET("sale.ofd.settings.get"),
    RPA_STUB("rpa.stub"),
    USER_ONLINE("user.online"),
    USER_COUNTERS("user.counters"),
    USER_HISTORY_LIST("user.history.list"),
    USER_HISTORY_FIELDS_LIST("user.history.fields.list"),
    PULL_APPLICATION_CONFIG_GET("pull.application.config.get"),
    PULL_APPLICATION_EVENT_ADD("pull.application.event.add"),
    PULL_APPLICATION_PUSH_ADD("pull.application.push.add"),
    PULL_WATCH_EXTEND("pull.watch.extend"),
    PULL_CONFIG_GET("pull.config.get"),
    PULL_CHANNEL_PUBLIC_GET("pull.channel.public.get"),
    PULL_CHANNEL_PUBLIC_LIST("pull.channel.public.list"),
    MOBILE_COUNTER_TYPES_GET("mobile.counter.types.get"),
    MOBILE_COUNTER_GET("mobile.counter.get"),
    MOBILE_COUNTER_CONFIG_GET("mobile.counter.config.get"),
    MOBILE_COUNTER_CONFIG_SET("mobile.counter.config.set"),
    MOBILE_PUSH_TYPES_GET("mobile.push.types.get"),
    MOBILE_PUSH_CONFIG_GET("mobile.push.config.get"),
    MOBILE_PUSH_CONFIG_SET("mobile.push.config.set"),
    MOBILE_PUSH_STATUS_GET("mobile.push.status.get"),
    MOBILE_PUSH_STATUS_SET("mobile.push.status.set"),
    MOBILE_PUSH_SMARTFILTER_STATUS_GET("mobile.push.smartfilter.status.get"),
    MOBILE_PUSH_SMARTFILTER_STATUS_SET("mobile.push.smartfilter.status.set"),
    MOBILE_USER_GET("mobile.user.get"),
    MOBILE_USER_UPDATE("mobile.user.update"),
    MOBILE_USER_CANUSETELEPHONY("mobile.user.canusetelephony"),
    MOBILE_USER_CANEDITUSERS("mobile.user.caneditusers"),
    MOBILE_USER_SETADMINRIGHTS("mobile.user.setadminrights"),
    MOBILE_USER_REMOVEADMINRIGHTS("mobile.user.removeadminrights"),
    MOBILE_USER_FIREUSER("mobile.user.fireuser"),
    MOBILE_USER_HIREUSER("mobile.user.hireuser"),
    MOBILE_FORM_PROFILE("mobile.form.profile"),
    MOBILE_DISK_FOLDER_GETCHILDREN("mobile.disk.folder.getchildren"),
    MOBILE_DISK_GETATTACHMENTSDATA("mobile.disk.getattachmentsdata"),
    MOBILE_DISK_GETUPLOADEDFILESFOLDER("mobile.disk.getuploadedfilesfolder"),
    MOBILE_DISK_GETFILEBYOBJECTID("mobile.disk.getfilebyobjectid"),
    MOBILE_SETTINGS_TABS_SET("mobile.settings.tabs.set"),
    MOBILE_SETTINGS_ENERGY_SET("mobile.settings.energy.set"),
    MOBILE_SETTINGS_ENERGY_GET("mobile.settings.energy.get"),
    MOBILE_SETTINGS_OTHER_SET("mobile.settings.other.set"),
    MOBILE_SETTINGS_OTHER_GET("mobile.settings.other.get"),
    MOBILE_INTRANET_DEPARTMENTS_GET("mobile.intranet.departments.get"),
    MOBILE_INTRANET_STRESSLEVEL_SHAREDATA_GET("mobile.intranet.stresslevel.sharedata.get"),
    MOBILE_TASKS_DEADLINES_GET("mobile.tasks.deadlines.get"),
    MOBILE_TASKS_GROUP_GETCANCREATETASK("mobile.tasks.group.getcancreatetask"),
    MOBILE_TASK_LINK_PARAMS_GET("mobile.task.link.params.get"),
    MOBILE_COMPONENT_CUSTOMPARAMS_SET("mobile.component.customparams.set"),
    MESSAGESERVICE_SENDER_UPDATE("messageservice.sender.update"),
    MESSAGESERVICE_MESSAGE_STATUS_GET("messageservice.message.status.get"),
    LISTS_GET_IBLOCK_TYPE_ID("lists.get.iblock.type.id"),
    LISTS_ADD("lists.add"),
    LISTS_GET("lists.get"),
    LISTS_UPDATE("lists.update"),
    LISTS_DELETE("lists.delete"),
    LISTS_SECTION_ADD("lists.section.add"),
    LISTS_SECTION_GET("lists.section.get"),
    LISTS_SECTION_UPDATE("lists.section.update"),
    LISTS_SECTION_DELETE("lists.section.delete"),
    LISTS_FIELD_ADD("lists.field.add"),
    LISTS_FIELD_GET("lists.field.get"),
    LISTS_FIELD_UPDATE("lists.field.update"),
    LISTS_FIELD_DELETE("lists.field.delete"),
    LISTS_FIELD_TYPE_GET("lists.field.type.get"),
    LISTS_ELEMENT_ADD("lists.element.add"),
    LISTS_ELEMENT_GET("lists.element.get"),
    LISTS_ELEMENT_UPDATE("lists.element.update"),
    LISTS_ELEMENT_DELETE("lists.element.delete"),
    LISTS_ELEMENT_GET_FILE_URL("lists.element.get.file.url"),
    LANDING_BLOCK_PUBLICATION("landing.block.publication"),
    LANDING_BLOCK_GETASSETSCONFIG("landing.block.getassetsconfig"),
    LANDING_SITE_MOVEFOLDER("landing.site.movefolder"),
    LANDING_SITE_SETSCOPE("landing.site.setscope"),
    LANDING_SITE_BINDINGTOMENU("landing.site.bindingtomenu"),
    LANDING_SITE_UNBINDINGFROMMENU("landing.site.unbindingfrommenu"),
    LANDING_SITE_BINDINGTOGROUP("landing.site.bindingtogroup"),
    LANDING_SITE_UNBINDINGFROMGROUP("landing.site.unbindingfromgroup"),
    LANDING_SITE_GETMENUBINDINGS("landing.site.getmenubindings"),
    LANDING_SITE_GETGROUPBINDINGS("landing.site.getgroupbindings"),
    LANDING_REPO_GETAPPINFO("landing.repo.getappinfo"),
    LANDING_REPO_BIND("landing.repo.bind"),
    LANDING_REPO_UNBIND("landing.repo.unbind"),
    LANDING_TEMPLATE_SETSITEREF("landing.template.setsiteref"),
    LANDING_TEMPLATE_SETLANDINGREF("landing.template.setlandingref"),
    LANDING_TEMPLATE_GETSITEREF("landing.template.getsiteref"),
    LANDING_TEMPLATE_GETLANDINGREF("landing.template.getlandingref"),
    LANDING_DEMOS_GETURLPREVIEW("landing.demos.geturlpreview"),
    LANDING_ROLE_ISENABLED("landing.role.isenabled"),
    LANDING_ROLE_ENABLE("landing.role.enable"),
    LANDING_SYSPAGE_SET("landing.syspage.set"),
    LANDING_SYSPAGE_GET("landing.syspage.get"),
    LANDING_SYSPAGE_DELETEFORSITE("landing.syspage.deleteforsite"),
    LANDING_SYSPAGE_DELETEFORLANDING("landing.syspage.deleteforlanding"),
    LANDING_SYSPAGE_GETSPECIALPAGE("landing.syspage.getspecialpage"),
    LANDING_REPOWIDGET_FETCHDATA("landing.repowidget.fetchdata"),
    LANDING_REPOWIDGET_DEBUG("landing.repowidget.debug"),
    LANDING_REPOWIDGET_GETAPPINFO("landing.repowidget.getappinfo"),
    LANDING_REPOWIDGET_BIND("landing.repowidget.bind"),
    LANDING_REPOWIDGET_UNBIND("landing.repowidget.unbind"),
    LANDING_REPOWIDGET_GETLIST("landing.repowidget.getlist"),
    LANDING_REPOWIDGET_CHECKCONTENT("landing.repowidget.checkcontent"),
    LANDING_REPOWIDGET_REGISTER("landing.repowidget.register"),
    LANDING_REPOWIDGET_UNREGISTER("landing.repowidget.unregister"),
    LANDING_CLOUD_CLOUD_GETREPOSITORY("landing_cloud.cloud.getrepository"),
    LANDING_CLOUD_CLOUD_GETDEMOSITELIST("landing_cloud.cloud.getdemositelist"),
    LANDING_CLOUD_CLOUD_GETDEMOPAGELIST("landing_cloud.cloud.getdemopagelist"),
    LANDING_CLOUD_CLOUD_GETURLPREVIEW("landing_cloud.cloud.geturlpreview"),
    LANDING_CLOUD_CLOUD_GETAPPITEMS("landing_cloud.cloud.getappitems"),
    LANDING_CLOUD_CLOUD_GETAPPITEMMANIFEST("landing_cloud.cloud.getappitemmanifest"),
    CRM_WEBFORM_LIST("crm.webform.list"),
    CRM_WEBFORM_RESULT_ADD("crm.webform.result.add"),
    CRM_BUTTON_LIST("crm.button.list"),
    CRM_BUTTON_WIDGETS_GET("crm.button.widgets.get"),
    CRM_BUTTON_GUEST_REGISTER("crm.button.guest.register"),
    CRM_INVOICE_FIELDS("crm.invoice.fields"),
    CRM_INVOICE_LIST("crm.invoice.list"),
    CRM_INVOICE_GET("crm.invoice.get"),
    CRM_INVOICE_ADD("crm.invoice.add"),
    CRM_INVOICE_UPDATE("crm.invoice.update"),
    CRM_INVOICE_DELETE("crm.invoice.delete"),
    CRM_INVOICE_GETEXTERNALLINK("crm.invoice.getexternallink"),
    CRM_SETTINGS_MODE_GET("crm.settings.mode.get"),
    CRM_STATUS_EXTRA_FIELDS("crm.status.extra.fields"),
    CRM_ENUM_ENTITYEDITOR_CONFIGURATION_SCOPE("crm.enum.entityeditor.configuration.scope"),
    CRM_DEALCATEGORY_FIELDS("crm.dealcategory.fields"),
    CRM_DEALCATEGORY_LIST("crm.dealcategory.list"),
    CRM_DEALCATEGORY_ADD("crm.dealcategory.add"),
    CRM_DEALCATEGORY_GET("crm.dealcategory.get"),
    CRM_DEALCATEGORY_UPDATE("crm.dealcategory.update"),
    CRM_DEALCATEGORY_DELETE("crm.dealcategory.delete"),
    CRM_DEALCATEGORY_STATUS("crm.dealcategory.status"),
    CRM_DEALCATEGORY_STAGE_LIST("crm.dealcategory.stage.list"),
    CRM_DEALCATEGORY_DEFAULT_GET("crm.dealcategory.default.get"),
    CRM_DEALCATEGORY_DEFAULT_SET("crm.dealcategory.default.set"),
    CRM_INVOICE_RECURRING_FIELDS("crm.invoice.recurring.fields"),
    CRM_INVOICE_RECURRING_LIST("crm.invoice.recurring.list"),
    CRM_INVOICE_RECURRING_ADD("crm.invoice.recurring.add"),
    CRM_INVOICE_RECURRING_GET("crm.invoice.recurring.get"),
    CRM_INVOICE_RECURRING_UPDATE("crm.invoice.recurring.update"),
    CRM_INVOICE_RECURRING_DELETE("crm.invoice.recurring.delete"),
    CRM_INVOICE_RECURRING_EXPOSE("crm.invoice.recurring.expose"),
    CRM_PRODUCTROW_FIELDS("crm.productrow.fields"),
    CRM_PRODUCTROW_ADD("crm.productrow.add"),
    CRM_PRODUCTROW_GET("crm.productrow.get"),
    CRM_PRODUCTROW_LIST("crm.productrow.list"),
    CRM_PRODUCTROW_UPDATE("crm.productrow.update"),
    CRM_PRODUCTROW_DELETE("crm.productrow.delete"),
    CRM_QUOTE_CONTACT_FIELDS("crm.quote.contact.fields"),
    CRM_QUOTE_CONTACT_ADD("crm.quote.contact.add"),
    CRM_QUOTE_CONTACT_DELETE("crm.quote.contact.delete"),
    CRM_QUOTE_CONTACT_ITEMS_GET("crm.quote.contact.items.get"),
    CRM_QUOTE_CONTACT_ITEMS_SET("crm.quote.contact.items.set"),
    CRM_QUOTE_CONTACT_ITEMS_DELETE("crm.quote.contact.items.delete"),
    CRM_ADDRESS_GETZONEID("crm.address.getzoneid"),
    CRM_ADDRESS_SETZONEID("crm.address.setzoneid"),
    CRM_ADDRESSTYPE_GETAVAILABLE("crm.addresstype.getavailable"),
    CRM_ADDRESSTYPE_GETZONEMAP("crm.addresstype.getzonemap"),
    CRM_ADDRESSTYPE_GETDEFAULTBYZONE("crm.addresstype.getdefaultbyzone"),
    CRM_ADDRESSTYPE_GETBYZONESORVALUES("crm.addresstype.getbyzonesorvalues"),
    CRM_INVOICE_USERFIELD_ADD("crm.invoice.userfield.add"),
    CRM_INVOICE_USERFIELD_GET("crm.invoice.userfield.get"),
    CRM_INVOICE_USERFIELD_LIST("crm.invoice.userfield.list"),
    CRM_INVOICE_USERFIELD_UPDATE("crm.invoice.userfield.update"),
    CRM_INVOICE_USERFIELD_DELETE("crm.invoice.userfield.delete"),
    CRM_EXTERNALCHANNEL_CONNECTOR_FIELDS("crm.externalchannel.connector.fields"),
    CRM_EXTERNALCHANNEL_CONNECTOR_LIST("crm.externalchannel.connector.list"),
    CRM_MULTIFIELD_FIELDS("crm.multifield.fields"),
    CRM_DUPLICATE_FINDBYCOMM("crm.duplicate.findbycomm"),
    CRM_WEBFORM_CONFIGURATION_GET("crm.webform.configuration.get"),
    CRM_SITEBUTTON_CONFIGURATION_GET("crm.sitebutton.configuration.get"),
    CRM_PERSONTYPE_FIELDS("crm.persontype.fields"),
    CRM_PERSONTYPE_LIST("crm.persontype.list"),
    CRM_PAYSYSTEM_FIELDS("crm.paysystem.fields"),
    CRM_PAYSYSTEM_LIST("crm.paysystem.list"),
    CRM_ITEM_DETAILS_CONFIGURATION_GET("crm.item.details.configuration.get"),
    CRM_ITEM_DETAILS_CONFIGURATION_SET("crm.item.details.configuration.set"),
    CRM_ITEM_DETAILS_CONFIGURATION_RESET("crm.item.details.configuration.reset"),
    CRM_ITEM_DETAILS_CONFIGURATION_FORCECOMMONSCOPEFORALL("crm.item.details.configuration.forcecommonscopeforall"),
    CRM_TRACKING_TRACE_ADD("crm.tracking.trace.add"),
    CRM_TRACKING_TRACE_DELETE("crm.tracking.trace.delete"),
    CRM_SITE_FORM_FILL("crm.site.form.fill"),
    CRM_SITE_FORM_USER_GET("crm.site.form.user.get"),
    CRM_CALLLIST_LIST("crm.calllist.list"),
    CRM_CALLLIST_GET("crm.calllist.get"),
    CRM_CALLLIST_ADD("crm.calllist.add"),
    CRM_CALLLIST_UPDATE("crm.calllist.update"),
    CRM_CALLLIST_ITEMS_GET("crm.calllist.items.get"),
    CRM_CALLLIST_STATUSLIST("crm.calllist.statuslist"),
    IMOPENLINES_REVISION_GET("imopenlines.revision.get"),
    IMOPENLINES_DIALOG_GET("imopenlines.dialog.get"),
    IMOPENLINES_DIALOG_FORM_SEND("imopenlines.dialog.form.send"),
    IMOPENLINES_DIALOG_MULTI_GET("imopenlines.dialog.multi.get"),
    IMOPENLINES_OPERATOR_PAUSE_START("imopenlines.operator.pause.start"),
    IMOPENLINES_OPERATOR_PAUSE_STOP("imopenlines.operator.pause.stop"),
    IMOPENLINES_OPERATOR_PAUSE_GET("imopenlines.operator.pause.get"),
    IMOPENLINES_OPERATOR_PAUSE_GETALL("imopenlines.operator.pause.getall"),
    IMOPENLINES_OPERATOR_PAUSE_GETHISTORY("imopenlines.operator.pause.gethistory"),
    IMOPENLINES_SESSION_MODE_UNPIN("imopenlines.session.mode.unpin"),
    IMOPENLINES_SESSION_MODE_UNPINALL("imopenlines.session.mode.unpinall"),
    IMOPENLINES_BOT_SESSION_OPERATOR("imopenlines.bot.session.operator"),
    IMOPENLINES_BOT_SESSION_MESSAGE_SEND("imopenlines.bot.session.message.send"),
    IMOPENLINES_BOT_SESSION_TRANSFER("imopenlines.bot.session.transfer"),
    IMOPENLINES_BOT_SESSION_FINISH("imopenlines.bot.session.finish"),
    IMOPENLINES_BOT_SESSION_DIALOG_NEW("imopenlines.bot.session.dialog.new"),
    IMOPENLINES_NETWORK_JOIN("imopenlines.network.join"),
    IMOPENLINES_NETWORK_MESSAGE_ADD("imopenlines.network.message.add"),
    IMOPENLINES_WIDGET_CONFIG_GET("imopenlines.widget.config.get"),
    IMOPENLINES_WIDGET_DIALOG_GET("imopenlines.widget.dialog.get"),
    IMOPENLINES_WIDGET_DIALOG_LIST("imopenlines.widget.dialog.list"),
    IMOPENLINES_WIDGET_USER_REGISTER("imopenlines.widget.user.register"),
    IMOPENLINES_WIDGET_CHAT_CREATE("imopenlines.widget.chat.create"),
    IMOPENLINES_WIDGET_USER_CONSENT_APPLY("imopenlines.widget.user.consent.apply"),
    IMOPENLINES_WIDGET_USER_GET("imopenlines.widget.user.get"),
    IMOPENLINES_WIDGET_OPERATOR_GET("imopenlines.widget.operator.get"),
    IMOPENLINES_WIDGET_VOTE_SEND("imopenlines.widget.vote.send"),
    IMOPENLINES_WIDGET_ACTION_SEND("imopenlines.widget.action.send"),
    IMOPENLINES_WIDGET_CRM_BINDINGS_GET("imopenlines.widget.crm.bindings.get"),
    IMOPENLINES_CONFIG_PATH_GET("imopenlines.config.path.get"),
    IMOPENLINES_CONFIG_GET("imopenlines.config.get"),
    IMOPENLINES_CONFIG_LIST_GET("imopenlines.config.list.get"),
    IMOPENLINES_CONFIG_UPDATE("imopenlines.config.update"),
    IMOPENLINES_CONFIG_ADD("imopenlines.config.add"),
    IMOPENLINES_CONFIG_DELETE("imopenlines.config.delete"),
    IMOPENLINES_CRM_CHAT_GETLASTID("imopenlines.crm.chat.getlastid"),
    IMCONNECTOR_LIST("imconnector.list"),
    IMCONNECTOR_ACTIVATE("imconnector.activate"),
    IMCONNECTOR_STATUS("imconnector.status"),
    IMCONNECTOR_CONNECTOR_DATA_SET("imconnector.connector.data.set"),
    IMCONNECTOR_REGISTER("imconnector.register"),
    IMCONNECTOR_UNREGISTER("imconnector.unregister"),
    IMCONNECTOR_SEND_MESSAGES("imconnector.send.messages"),
    IMCONNECTOR_UPDATE_MESSAGES("imconnector.update.messages"),
    IMCONNECTOR_DELETE_MESSAGES("imconnector.delete.messages"),
    IMCONNECTOR_SEND_STATUS_DELIVERY("imconnector.send.status.delivery"),
    IMCONNECTOR_SEND_STATUS_READING("imconnector.send.status.reading"),
    IMCONNECTOR_SET_ERROR("imconnector.set.error"),
    IMCONNECTOR_CHAT_NAME_SET("imconnector.chat.name.set"),
    IMBOT_SUPPORT24_QUESTION_CONFIG_GET("imbot.support24.question.config.get"),
    IMBOT_SUPPORT24_QUESTION_ADD("imbot.support24.question.add"),
    IMBOT_SUPPORT24_QUESTION_LIST("imbot.support24.question.list"),
    IMBOT_SUPPORT24_QUESTION_SEARCH("imbot.support24.question.search"),
    IMBOT_NETWORK_QUESTION_ADD("imbot.network.question.add"),
    IMBOT_NETWORK_QUESTION_LIST("imbot.network.question.list"),
    IMBOT_NETWORK_QUESTION_SEARCH("imbot.network.question.search"),
    IMBOT_REGISTER("imbot.register"),
    IMBOT_UNREGISTER("imbot.unregister"),
    IMBOT_UPDATE("imbot.update"),
    IMBOT_DIALOG_GET("imbot.dialog.get"),
    IMBOT_DIALOG_VOTE("imbot.dialog.vote"),
    IMBOT_CHAT_ADD("imbot.chat.add"),
    IMBOT_CHAT_GET("imbot.chat.get"),
    IMBOT_CHAT_SETOWNER("imbot.chat.setowner"),
    IMBOT_CHAT_SETMANAGER("imbot.chat.setmanager"),
    IMBOT_CHAT_UPDATECOLOR("imbot.chat.updatecolor"),
    IMBOT_CHAT_UPDATETITLE("imbot.chat.updatetitle"),
    IMBOT_CHAT_UPDATEAVATAR("imbot.chat.updateavatar"),
    IMBOT_CHAT_LEAVE("imbot.chat.leave"),
    IMBOT_CHAT_USER_ADD("imbot.chat.user.add"),
    IMBOT_CHAT_USER_DELETE("imbot.chat.user.delete"),
    IMBOT_CHAT_USER_LIST("imbot.chat.user.list"),
    IMBOT_CHAT_SENDTYPING("imbot.chat.sendtyping"),
    IMBOT_BOT_LIST("imbot.bot.list"),
    IMBOT_MESSAGE_ADD("imbot.message.add"),
    IMBOT_MESSAGE_DELETE("imbot.message.delete"),
    IMBOT_MESSAGE_UPDATE("imbot.message.update"),
    IMBOT_MESSAGE_LIKE("imbot.message.like"),
    IMBOT_COMMAND_REGISTER("imbot.command.register"),
    IMBOT_COMMAND_UNREGISTER("imbot.command.unregister"),
    IMBOT_COMMAND_UPDATE("imbot.command.update"),
    IMBOT_COMMAND_ANSWER("imbot.command.answer"),
    IMBOT_APP_REGISTER("imbot.app.register"),
    IMBOT_APP_UNREGISTER("imbot.app.unregister"),
    IMBOT_APP_UPDATE("imbot.app.update"),
    IM_USER_BUSINESS_LIST("im.user.business.list"),
    IM_CHAT_GETENTITYCHAT("im.chat.getentitychat"),
    IM_CHAT_SETMANAGER("im.chat.setmanager"),
    IM_DIALOG_GET("im.dialog.get"),
    IM_NOTIFY("im.notify"),
    IM_NOTIFY_READ_ALL("im.notify.read.all"),
    IM_DISK_RECORD_SHARE("im.disk.record.share"),
    HUMANRESOURCES_HCMLINK_COMPANY_ADD("humanresources.hcmlink.company.add"),
    HUMANRESOURCES_HCMLINK_COMPANY_UPDATE("humanresources.hcmlink.company.update"),
    HUMANRESOURCES_HCMLINK_COMPANY_DELETE("humanresources.hcmlink.company.delete"),
    HUMANRESOURCES_HCMLINK_COMPANY_LIST("humanresources.hcmlink.company.list"),
    HUMANRESOURCES_HCMLINK_COMPANY_USER_LIST("humanresources.hcmlink.company.user.list"),
    HUMANRESOURCES_HCMLINK_EMPLOYEE_SET("humanresources.hcmlink.employee.set"),
    HUMANRESOURCES_HCMLINK_EMPLOYEE_LIST("humanresources.hcmlink.employee.list"),
    HUMANRESOURCES_HCMLINK_FIELD_VALUE_SET("humanresources.hcmlink.field.value.set"),
    HUMANRESOURCES_HCMLINK_JOB_UPDATE("humanresources.hcmlink.job.update"),
    HUMANRESOURCES_HCMLINK_JOB_STATUS_GET("humanresources.hcmlink.job.status.get"),
    FORUM_MESSAGE_DELETE("forum.message.delete"),
    DOCUMENTGENERATOR_STUB("documentgenerator.stub"),
    DISK_FOLDER_SHARETOUSER("disk.folder.sharetouser"),
    DISK_FOLDER_LISTALLOWEDOPERATIONS("disk.folder.listallowedoperations"),
    DISK_FILE_LISTALLOWEDOPERATIONS("disk.file.listallowedoperations"),
    CALENDAR_USER_SETTINGS_GET("calendar.user.settings.get"),
    LIKE_LIST("like.list"),
    LIKE_REACTIONS("like.reactions"),
    SMILE_GET("smile.get"),
    ;
    private static final Map<String, Method> byName = new TreeMap<>(String.CASE_INSENSITIVE_ORDER);
    static {
        for (Method m :
                values()) {
